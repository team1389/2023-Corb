...
public class RobotMap {
    ...
    public static final class DriveConstants {
        ...
        public static final double MAX_METERS_PER_SEC = 4; // m/s
        public static final double MAX_RADIANS_PER_SEC = 5; // rad/s

        public static final double MAX_LINEAR_ACCEL = 7; // m/s/s
        public static final double MAX_ANGULAR_ACCEL = 9; // rad/s/s
