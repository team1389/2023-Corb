...
public class OneTopCube extends SequentialCommandGroup{
    ...
    public OneTopCube(Drivetrain drivetrain, Arm arm, Intake intake, HashMap<String, Command> hmm){
        
        PathPlannerTrajectory trajectory = PathPlanner.loadPath("1 Top Cube", new PathConstraints(
