...
public class OneBottomCone extends SequentialCommandGroup{
    ...
    public OneBottomCone(Drivetrain drivetrain, Arm arm, Intake intake, HashMap<String, Command> hmm){

        PathPlannerTrajectory trajectory = PathPlanner.loadPath("1 Bottom Cone", new PathConstraints(
