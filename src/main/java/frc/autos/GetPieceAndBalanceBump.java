...
public class GetPieceAndBalanceBump extends SequentialCommandGroup{
    
    public GetPieceAndBalanceBump(Drivetrain drivetrain, Arm arm, Intake intake, HashMap<String, Command> hmm){
        List<PathPlannerTrajectory> trajectories = PathPlanner.loadPathGroup("Piece and Balance (bump)", new PathConstraints(
