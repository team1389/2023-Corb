...
public class OneBottomCube extends SequentialCommandGroup{
    ...
    public OneBottomCube(Drivetrain drivetrain, Arm arm, Intake intake){
        
        PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("1 Bottom Cube Initial", new PathConstraints(
            AutoConstants.AUTO_MAX_METERS_PER_SEC, 
            AutoConstants.AUTO_MAX_MPSS)
        );
        PathPlannerTrajectory trajectory2 = PathPlanner.loadPath("1 Bottom Cube Balance", new PathConstraints(
            AutoConstants.AUTO_MAX_METERS_PER_SEC, 
            AutoConstants.AUTO_MAX_MPSS)
        );
